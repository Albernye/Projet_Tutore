...
M = 0.837;                      % body mass (kg)
W = 0.085;						% body width (m)
D = 0.12;						% body depth (m)
L = 0.11;						% distance of the center of mass from the wheel axle (m)
T = 0.96;                       % Time period of oscillation, gyroboy hanging down as pendulum (s)
