...
PRODUCT_NAME              = LegoEV3_poursuite
MAKEFILE                  = LegoEV3_poursuite.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LegoEV3_poursuite
...
DEFINES_STANDARD = -DMODEL=LegoEV3_poursuite -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/LegoEV3_poursuite_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/LegoEV3_poursuite_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/LegoEV3_poursuite_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LegoEV3_poursuite.o : $(START_DIR)/LegoEV3_poursuite_ert_rtw/LegoEV3_poursuite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
