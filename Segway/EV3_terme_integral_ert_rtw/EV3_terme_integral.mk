###########################################################################
## Makefile generated for component 'EV3_terme_integral'. 
## 
## Makefile     : EV3_terme_integral.mk
## Generated on : Thu Jan 15 12:01:40 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/EV3_terme_integral
...
PRODUCT_NAME              = EV3_terme_integral
MAKEFILE                  = EV3_terme_integral.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/EV3_terme_integral
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/ev3/include -I$(START_DIR)/EV3_terme_integral_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I"$(EV3_LMSTYPES_DIR)/.." -I"$(EV3_LMS2012_DIR)/.." -I"$(EV3_BYTECODES_DIR)/.." -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/ev3/src
...
DEFINES_STANDARD = -DMODEL=EV3_terme_integral -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = EV3_terme_integral.o linuxinitialize.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_pixy2_vision_sensor.o driver_ev3_encoder.o driver_ev3_gyro_sensor.o driver_ev3_motor.o
...
%.o : $(START_DIR)/EV3_terme_integral_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/EV3_terme_integral_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/EV3_terme_integral_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


EV3_terme_integral.o : $(START_DIR)/EV3_terme_integral_ert_rtw/EV3_terme_integral.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
driver_ev3_button.o : C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/ev3/src/driver_ev3_button.c
	$(CC) $(CFLAGS) -o "$@" "$<"


driver_ev3_lcd.o : C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/ev3/src/driver_ev3_lcd.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_legoev3init.o : C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/ev3/src/MW_legoev3init.c
	$(CC) $(CFLAGS) -o "$@" "$<"


driver_pixy2_vision_sensor.o : C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/ev3/src/driver_pixy2_vision_sensor.c
	$(CC) $(CFLAGS) -o "$@" "$<"
